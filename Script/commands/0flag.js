...
module.exports.config = {
  ...
  usages: "country / দেশ / desh / flag",
  cooldowns: 5,
  usePrefix: true,
  aliases: ["দেশ", "desh", "flags"]
};
    ...
    return api.sendMessage(
      ...
      (err, info) => {
        ...
        global.client.handleReply.push({
          ...
          author: null, // গ্রুপের যেকোনো সদস্য উত্তর দিতে পারবে
...
module.exports.handleReply = async function ({
  ...
  try {
    // একবার উত্তর দিলে পরবর্তী রিপ্লাই সম্পূর্ণ ইগনোর করবে
    ...
    // উত্তর দেওয়ার পর মেসেজ লক করা হলো
